...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
   ...
   <?php 
   	$user_id = $_SESSION['id'];
    $conn2=mysqli_connect("localhost","root","","bookingcalendar");
  ...
  ?>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<caption><h2>Your booked slots</h2></caption>
				<table class="table">
				  ...
				  <tbody>
				  	<?php 
			            ...
			            while($arr=mysqli_fetch_array($sel, MYSQLI_ASSOC))
			           {
			           	  $i=$arr["id"]; 
			              //echo $i;
			              $name=$arr["name"];
						  ...
						  echo '<tr>
						      ...
						      <td><form method="POST">
					                ...
					                <button name="deleteSlot" class="btn btn-xs btn-danger"><svg class="bi bi-trash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="row">
			<div class="col-md-12">
				<center><a class='btn btn-xs btn-primary' href='calendar.php'>Book a new slot</a> </center>
			</div>
		</div>
	</div>
</body>		
